...
namespace _LinkedList {
  class Program {
    static void Main(string[] args) {
      ...
      string[] palabras = { "Uno", "mas", "Dos", "mas", "Tres", "mas" };
      ...
      Console.WriteLine("oracion.Contains(\"Cuatro\") = {0}", oracion.Contains("Cuatro"));

      // Add the word 'today' to the beginning of the linked list.
      oracion.AddFirst("Cero");
      Muestrame(oracion, "\nPrueba 1: Añadir 'Cero' al principio de la lista enlazada:");
      ...
      oracion.RemoveLast();
      oracion.AddLast("Siete");
      Muestrame(oracion, "\nPrueba 3: Cambiar el último nodo a 'Siete':");
